...
<head>
    <meta charset="utf-8">
    <title>jamur- Home Repair Website Template</title>
...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-4 text-white animated slideInDown mb-4">daftar</h1>
        ...
        <div class="container">
            <div class="d-flex g-5">
                <div class="col-lg-6 mx-4">
                    <img src="<?= base_url(); ?>/img/logo-jamur.png"class="img-thumbnail" alt="...">
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="border-start border-5 border-primary ps-4 mb-5">
                        <h1 class="text-body text-uppercase mb-2">daftar </h1>
                    </div>
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <label for="name">Your nama </label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating">
